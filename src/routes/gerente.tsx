      ...
      <main className="flex-1 flex items-start justify-center px-4 py-6">
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <div className="relative bg-gradient-to-b from-[#EAF1FF] to-white border border-blue-100 rounded-xl p-6 mb-6">
            <svg className="absolute top-4 left-4 w-5 h-5 text-[#3483FA]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M6 17h3l2-4V7H5v6h3l-2 4zm8 0h3l2-4V7h-6v6h3l-2 4z" />
            </svg>

            <div className="flex flex-col items-center">
              <div className="w-32 h-32 rounded-full p-1 bg-gradient-to-br from-[#3483FA] to-[#1d5fc4] mb-3">
              ...
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#3483FA] to-[#1d5fc4] text-white text-xs font-semibold py-1.5 px-4 rounded-full shadow">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex items-center gap-2 border-b-2 border-[#3483FA] pb-2 mb-6">
