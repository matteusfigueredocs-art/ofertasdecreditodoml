...
function Gerente() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="bg-[#F4D147] w-full h-3" />
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <div className="relative bg-gradient-to-b from-[#EAF1FF] to-white border border-blue-100 rounded-xl p-6 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-32 h-32 rounded-full p-1 bg-gradient-to-br from-[#F4D147] to-[#1d5fc4] mb-3">
              ...
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#F4D147] to-[#1d5fc4] text-white text-xs font-semibold py-1.5 px-4 rounded-full shadow">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex items-center gap-2 border-b-2 border-[#F4D147] pb-2 mb-6">
