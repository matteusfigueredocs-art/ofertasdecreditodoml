...
function Endereco() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSaving(false);
      setSuccess(true);
      setTimeout(() => navigate({ to: "/envio", search: form as never }), 2200);
    }, 1500);
  };
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#2A68C8] hover:bg-[#1E5BBA] disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed text-white font-bold py-4 rounded-lg shadow-md transition-colors mt-2"
            >
