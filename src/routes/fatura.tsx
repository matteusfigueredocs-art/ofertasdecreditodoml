    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md p-6 md:p-8">
          ...
          <div className="bg-gradient-to-r from-[#EAF2FE] to-white border border-[#3483FA]/20 rounded-lg p-4 flex items-start gap-3">
            <div className="w-9 h-9 rounded-full bg-[#3483FA] flex items-center justify-center shrink-0">
      ...
      {selected !== null && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center px-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
            <div className="h-1.5 bg-[#3483FA]" />
            <div className="p-8 flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-[#3483FA]/10 flex items-center justify-center mb-5 ring-8 ring-[#3483FA]/5">
                <div className="w-16 h-16 rounded-full bg-[#3483FA] flex items-center justify-center">
              ...
              <div className="w-full bg-[#EAF2FE]/60 border border-[#3483FA]/20 rounded-lg py-4 px-4 mb-5">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <div className="w-4 h-4 rounded-full border-2 border-[#3483FA] border-t-transparent animate-spin" />
